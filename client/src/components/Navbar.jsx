      ...
      <div className="relative flex flex-col w-full p-5 mx-auto bg-white md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
        <div className="flex flex-row items-center justify-between lg:justify-start">
          <a href="/" className="text-lg tracking-tight text-black uppercase focus:outline-none focus:ring lg:text-2xl">
            <span className="font-bold tracking-tight dark:text-black">ticketmasterbot</span>
          </a>
          <button
        ...
        <nav className={`flex-col items-center flex-grow md:pb-0 ${open ? 'flex' : 'hidden'} md:flex md:justify-end md:flex-row`}>
