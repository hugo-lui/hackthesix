      ...
      <div className="relative flex flex-col w-full p-5 mx-auto bg-white md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 list-none lg:ml-auto">
            ...
            <Link
              to="/signin"
              className="inline-flex items-center justify-center px-4 py-2 text-sm font-semibold text-white  rounded-full group focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2  active:bg-gray-800 active:text-white focus-visible:outline-black"
            >
              Sign in
            </Link>
          </div>
